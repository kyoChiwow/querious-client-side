    ...
    return (
        <div className="bg-base-100 rounded-2xl p-4 shadow-xl">
            ...
            <div className="flex flex-col xl:flex-row items-center gap-12 md:gap-16">
                {/* Image div */}
                <div>
                    <img className="w-full h-[130px] rounded-2xl" src={recommendPhoto} alt={recommendName} />
                </div>
                {/* Image div */}

                {/* Information div */}
                <div className="bg-base-300 p-2 rounded-2xl bg-opacity-50 shadow-xl xl:w-[75%]">
